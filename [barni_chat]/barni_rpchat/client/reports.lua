...
RegisterNetEvent('barni_rpchat:send')
AddEventHandler('barni_rpchat:send', function(id, name, message)
	local sourceID = PlayerId()
	local playerID = GetPlayerFromServerId(id)
	ESX.TriggerServerCallback('barni_rpchat:getPlayerGroup', function(pgroup)
